...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./serilog-enrichers-scopedlogcontext.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./serilog-enrichers-scopedlogcontext.sln", new DotNetBuildSettings
    {
